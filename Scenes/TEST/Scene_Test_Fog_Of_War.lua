return {
    new = function(_pName)
        ...
        function Scene:Load()
            ...
            light:Add_Component(require('Libraries/ECS/Components/Lighting/c_Fog_Remover').new())
            light:Add_Component(require('Libraries/ECS/Components/Movement/c_Transform').new(0, 0))
